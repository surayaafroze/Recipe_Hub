...
export default function Footer() {
  return (
    <footer className="bg-white dark:bg-zinc-900 border-t border-gray-200 dark:border-zinc-800 pt-10 pb-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="mb-6 md:mb-0">
            <Link href="/" className="text-2xl font-bold text-gray-800 dark:text-white mb-4 block">
              RecipeHub
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/browse-recipes" className="text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 text-sm">Browse Recipes</Link></li>
              <li><Link href="/login" className="text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 text-sm">Login</Link></li>
              <li><Link href="/register" className="text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 text-sm">Register</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-500 dark:text-gray-400">
              ...
              <li>Email: contact@recipehub.com</li>
        ...
        <div className="border-t border-gray-200 dark:border-zinc-800 mt-8 pt-8 text-center sm:flex sm:justify-between sm:text-left">
